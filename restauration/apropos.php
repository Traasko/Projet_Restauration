        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-12 text-center heading-wrap">
              <h2>Nos Chefs</h2>
              <span class="back-text">Nos Chefs</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row mb-5">
          ...
          <div class="col-md-5 mb-5">
            <div class="mb-5">
              <h3>Heurs d'ouvertures</h3>
              <p><strong class="d-block">Dimanche-Thursday</strong> 17h - 22h</p>
            </div>
            <div>
              <h3>Informations</h3>
              <ul class="list-unstyled footer-link">
                ...
                <li class="d-block"><span class="d-block">Telephone:</span><span class="text-white">01 23 45 67 89</span></li>
                <li class="d-block"><span class="d-block">Email:</span><span class="text-white">expertschefs@way.com</span></li>
              </ul>
            </div>
          </div>
